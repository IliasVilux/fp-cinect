    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-10 rounded-xl">
            <div class="relative mb-7 grid auto-rows-min grid-cols-3 gap-2 lg:gap-4 p-4 lg:mb-10">
                ...
                <div class="absolute bottom-0 z-10 h-1/3 w-full bg-gradient-to-t from-neutral-950/100 to-neutral-950/0">
                </div>
                ...
                <h3 class="absolute bottom-2 left-3 z-20 text-2xl font-medium capitalize lg:text-xl lg:font-bold">{{
                    content.type }}</h3>
                </Link>
